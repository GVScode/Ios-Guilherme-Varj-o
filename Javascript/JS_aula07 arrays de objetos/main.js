...
//seleciona os resultados a partir de uma pré determinação
console.clear();
const {
    firstName,
    lastName,
...
//separa o importante e junta todo o resto
console.clear();
...
// JSON
const tarefa_JSON =
    '[{"id":1,"texto":"Levar o lixo parafora","isCompleted":true},{"id":2,"texto":"Encontrar com o chefe","isCompleted":true},{"id":3,"texto":"Consulta no dentista","isCompleted":false}]';
